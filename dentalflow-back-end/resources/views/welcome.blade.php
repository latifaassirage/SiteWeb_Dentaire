    ...
    <head>
        ...
        @else
            <style>
                ...
                .-\[0\.328613\] { margin-left: -0.328613; }
                .-\[0\.4rem\] { margin-left: -0.4rem; }
                .-\[6\.6rem\] { margin-top: -6.6rem; }
                .-\[26px\] { margin-left: -26px; }
                .-\[51px\] { margin-left: -51px; }
                .-\[78px\] { margin-left: -78px; }
                .-\[102px\] { margin-left: -102px; }
                .max-w-none { max-width: none; }
                .-\[51px\]:not(.starting) { margin-left: -51px; }
                .starting\:opacity-0 { opacity: 0; }
                .starting\:translate-y-6 { transform: translateY(1.5rem); }
                .motion-safe\:starting\:translate-y-6 { transform: translateY(1.5rem); }
                ...
                .text-\[\#F3BEC7\] { color: #F3BEC7; }
                .text-\[\#F8B803\] { color: #F8B803; }
                .dark\:text-black { color: black; }
                .dark\:text-\[\#4B0600\] { color: #4B0600; }
                .dark\:text-\[\#391800\] { color: #391800; }
                .dark\:text-\[\#733000\] { color: #733000; }
                .stroke-\[2\.4\] { stroke-width: 2.4; }
                .stroke-\[var\(--stroke-color\)\] { stroke: var(--stroke-color); }
                .fill-current { fill: currentColor; }
                .fill-none { fill: none; }
                .mask-\[url\(\#path-1-mask\)\] { mask: url(#path-1-mask); }
                .mask-\[url\(\#path-2-mask\)\] { mask: url(#path-2-mask); }
                .mask-\[url\(\#path-3-mask\)\] { mask: url(#path-3-mask); }
                .mask-\[url\(\#path-4-mask\)\] { mask: url(#path-4-mask); }
                .mask-\[url\(\#path-5-mask\)\] { mask: url(#path-5-mask); }
                .mask-units-userSpaceOnUse { mask-units: userSpaceOnUse; }
                .mask-units-userSpaceOnUse { mask-units: userSpaceOnUse; }
                .mask-units-userSpaceOnUse { mask-units: userSpaceOnUse; }
                .mask-units-userSpaceOnUse { mask-units: userSpaceOnUse; }
                .mask-units-userSpaceOnUse { mask-units: userSpaceOnUse; }
